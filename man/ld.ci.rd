...
\usage{
ld.ci(var, time, subject, group=NULL, alpha=0.05, 
time.name="Time", group.name="Group", description=TRUE)
}

\arguments{
  \item{var}{a vector of variable of interest.}
...
group<-factor(rep(paste(shoulder[,"Treat"],shoulder[,"Gender"],sep=""),6))
ex.ci.2<-ld.ci(var,time,subject,group=group,alpha=0.05,
time.name="Time",group.name="Group",description=FALSE)

## Output for the ld.ci function
ex.ci.2$summary
